...
class WC_ECHEPAY_GATEWAY_FOR_WOOCOMMERCE_Gateway extends WC_Payment_Gateway_CC
{
  ...
  public function __construct()
  {
    ...
    add_action('woocommerce_api_echezona_payment_callback', array($this, 'check_echepay_gateway_for_woocommerce_response'));
  ...
  public function payment_fields()
  {
    ...
    // Note: We don't call parent::payment_fields() because we redirect to an external payment page
    // and don't need to collect card details on the checkout page
  }
  ...
  public function payment_scripts()
  {
    ...
    wp_enqueue_script('echezona', ECHEPAY_GATEWAY_FOR_WOOCOMMERCE_PLUGIN_URL . 'assets/js/payment.js', array('jquery'), ECHEPAY_GATEWAY_FOR_WOOCOMMERCE_VERSION, true);
   ...
   */
  public function check_echepay_gateway_for_woocommerce_response()
  {
